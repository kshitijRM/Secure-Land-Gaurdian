...
import { Eye, Zap, ShieldOff } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {impacts.map((item, i) => (
            <motion.div
              ...
              className="bg-[#0F0F0F] border border-white/5 rounded-2xl p-8 sm:p-10 text-center group hover:border-white/15 transition-all duration-500 relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                <div className="w-12 h-12 rounded-xl bg-[#1A1A1A] border border-white/10 flex items-center justify-center mx-auto mb-6">
